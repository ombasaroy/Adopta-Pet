  ...
  <div class="col-md-6" style="">
        <div class="card card-signup">
          <div class=" signup-card-body">
            ...
            <P>Enter the email address and username you previously used to login</P>
            <hr>
            <form action="#" method="post">
              ...
              <div class="form-group">
                <label for="username" class="signuplabel">Username</label>
              ...
              <div class="form-group" class="regbuttondiv">
                <input type="submit" name="register" id="registerbtn" value="RESET PASSWORD" class="btn btn-block regbutton btn-dark">
