  ...
  //deleting a record
       ...
       if (isset($_GET['delete'])) {
        ...
        if ($conn->query($delete_sql) === TRUE) {
          # code...
           header('location: cats.php?recorddeleted');
        }else{
           header('location: cats.php?recordnotdeleted');
        }
  ...
  <div class="container-fluid">
  	<div class="row wrapper">
  		<div class="col sidebar">
  			...
  			<a href="" style="background-color: #C00040; padding: 5px;"><i class="fa fa-cat"></i>		Cats<i class="fa fa-caret-right" style=" padding-left: 50%;"></i></a>
        ...
        <div style="margin-top: 10px;">
          ...
          $result = $mysqli->query("SELECT pets.*,users.full_name, users.phone_number  FROM pets pets INNER JOIN users ON pets.user_id = users.id WHERE pet_type = 'cat'") or die($mysqli->error);
      ...
      <table class="table table-hover table-fixed"> 
        ...
        <tbody>
          ...
          <td>
          <a href="cats.php?delete=<?php echo $row['id'] ?>" class="btn btn-danger">Delete</a>
          </td>
