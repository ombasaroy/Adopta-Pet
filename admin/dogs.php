<?php
  ...
  if (!isset($_SESSION['logged'])) {
       ...
       //session variales
       $_SESSION['recordDeleted'] = "Dog record deleted";
       $_SESSION['recordNotDeleted'] = "Dog record not deleted"; 
  ...
  //deleting a record
       ...
       if (isset($_GET['delete'])) {
        ...
        if ($conn->query($delete_sql) === TRUE) {
          ...
          //  </script>";
           header('location: dogs.php?recorddeleted');
        }else{
          // echo "<script>
          //     alert('Record not deleted')
          //  </script>";
           header('location: dogs.php?recordnotdeleted');
        }
  ...
  <div class="container-fluid">
  	<div class="row wrapper">
  		<div class="col sidebar">
  			...
  			<a href="" style="background-color: #C00040; padding: 5px;"><i class="fa fa-dog"></i>		Dogs<i class="fa fa-caret-right" style=" padding-left: 50%;"></i></a>
        ...
        <div style="margin-top: 10px;">
          ...
          $result = $mysqli->query("SELECT pets.*,users.full_name, users.phone_number  FROM pets pets INNER JOIN users ON pets.user_id = users.id WHERE pet_type = 'dog'") or die($mysqli->error);
      ...
      <table class="table table-hover table-fixed"> 
        ...
        <tbody>
          ...
          <td><?php echo "<img src='../petimages/" .$row['pet_image']. "'style='width:100px; height:70px;'>"?></td>
          ...
          <td> 
          <a href="dogs.php?delete=<?php echo $row['id'] ?>" class="btn btn-danger">Delete</a>
          </td>
