          ...
          <div class=" signup-card-body">
            ...
            <form action="#" method="post">
              ...
              <div class="form-group">
                <label for="regfirstname" class="signuplabel">First name</label>
              <input type="text" name="regfirstname" id="regfirstname" placeholder="Enter your first name" class="form-control" required="">
                
              </div>
              <!-- OTHERS NAMES -->

              <div class="form-group">
                <label for="regothernames" class="signuplabel">Other names</label>
              <input type="text" name="regothernames" id="regothernames" placeholder="Enter other names" class="form-control" required="">
              ...
              <input type="password" name="regpassword" id="regpassword" placeholder="Password" class="form-control" required="">
              ...
              <div class="form-group">
                <label class="signuplabel">Already registered?<a href="login.html">Sign in</a>
                </label>
              </div>
