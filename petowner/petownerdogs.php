  ...
  //deleting a record
       ...
       if (isset($_GET['delete'])) {
        ...
        if ($conn->query($delete_sql) === TRUE) {
          # code...
           header('location: petownerdogs.php?recorddeleted');
        }else{
           header('location: petownerdogs.php?recordnotdeleted');
        }
  ...
  <div class="container-fluid">
  	<div class="row wrapper">
  		<div class="col sidebar">
  			...
  			<a href="petownerdogs.php" style="background-color: #C00040; padding: 5px;"><i class="fa fa-dog"></i>		Dogs<i class="fa fa-caret-right" style=" padding-left: 50%;"></i></a>
        ...
        <div style="margin-top: 10px;">
         ...
         <?php
          ...
          $result = $mysqli->query("SELECT * FROM pets WHERE pet_type = 'dog' AND user_id=".$_SESSION['id']) or die($mysqli->error);
        ...
        <tbody>
          ...
          <a href="petownerdogs.php?delete=<?php echo $row['id'] ?>" class="btn btn-danger">Delete</a>
          </td>
