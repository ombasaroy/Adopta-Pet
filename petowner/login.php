  ...
  <div class="col-md-6" style="">
        <div class="card card-signup">
          <div class=" signup-card-body">
            <h5 class="signup-card-title">LOGIN</h5>
            <hr>
            ...
            <div>
              ...
              session_start();
                if (isset($_GET['wrongcred'])) {
                  ...
                  # code...
                  echo "<div class='alert alert-danger'>".$_SESSION['notVerified']." </div>";
                  session_unset();
                  session_destroy();
            ...
            <form action="../authentication/access.php" method="post">
              ...
              <div class="form-group">
                <label for="login_email" class="signuplabel">Email</label>
              <input type="email" name="login_email" id="login_email" placeholder="Enter your email" class="form-control" required="">
                
              </div>

      
              <div class="form-group">
                <label for="login_password" class="signuplabel">Password</label>
              ...
              <div class="form-group" class="regbuttondiv">
                <input type="submit" name="login" id="loginbtn" value="LOGIN" class="btn btn-block regbutton btn-dark">
                
              </div>
              <div class="form-group">
                <label class="signuplabel">Not registered?<a href="signup.php">Sign up here</a>
                </label>
              </div>
              <div class="form-group">
