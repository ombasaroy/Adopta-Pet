...
include '../connection.php';
    ...
    $counter_sql_dogs = "SELECT COUNT(*) AS counter_dogs  FROM pets WHERE pet_type='dog' AND user_id=".$_SESSION['id']; 
    $counter_sql_cats = "SELECT COUNT(*) AS counter_cats  FROM pets WHERE pet_type='cat' AND user_id=".$_SESSION['id'];
...
<!-- NAVIGATION BAR STARTS HERE -->
  ...
  <div class="container-fluid">
  	<div class="row wrapper">
       ...
       <h2>MY PANEL</h2>
        <hr>
        <a href="petownerdashboard.php" style="background-color: #C00040; padding: 5px;"><i class="fa fa-tachometer-alt"></i>    Dashboard<i class="fa fa-caret-right" style=" padding-left: 30%;"></i></a>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="row stats-row">
            <div class="col stats">
              <h3 class="stats-col"> MY CATS</h3>
              <h1><?php echo $cats;?></h1>
            </div>
              <div class="col stats">
                <h3 class="stats-col">MY DOGS</h3>
                <h1><?php echo $dogs;?></h1>
            </div>
